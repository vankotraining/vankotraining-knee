...
-- 3. Require the same admin check inside soft-delete/restore RPC functions.
--
...
-- Client records: the internal admin can read, create, and update.
...
-- Athlete profiles: the internal admin can read, create, and update.
...
-- Knee measurements: the internal admin can read, create, and update.
